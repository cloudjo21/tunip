...
class LakeMetaEntityStatDomainSnapshotPath(LakeMetaEntityStatDomainPath):
    def __init__(self, user_name, domain_name, snapshot_dt):
        super(LakeMetaEntityStatDomainSnapshotPath, self).__init__(user_name, domain_name)
        self.snapshot_dt = snapshot_dt
    ...
    @classmethod
    def from_parent(cls, parent: LakeMetaEntityStatDomainPath, snapshot_dt: str):
        return LakeMetaEntityStatDomainSnapshotPath(
            parent.user_name, parent.domain_name, snapshot_dt
        )